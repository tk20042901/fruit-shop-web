...
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Trần Minh Nam'), 22);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Trần Minh Nam'), 5);

-- Order items cho đơn hàng của: Lê Thị Lan
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Lê Thị Lan'), 12);

-- Order items cho đơn hàng của: Phạm Văn Dũng
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Phạm Văn Dũng'), 30);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Phạm Văn Dũng'), 1);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Phạm Văn Dũng'), 18);

-- Order items cho đơn hàng của: Hoàng Ngọc Anh
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Hoàng Ngọc Anh'), 35);

-- Order items cho đơn hàng của: Vũ Hữu Bình
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Vũ Hữu Bình'), 9);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Vũ Hữu Bình'), 27);

-- Order items cho đơn hàng của: Bùi Văn Cường
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Bùi Văn Cường'), 8);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Bùi Văn Cường'), 14);

-- Order items cho đơn hàng của: Đỗ Thanh Mai
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Đỗ Thanh Mai'), 31);

-- Order items cho đơn hàng của: Nguyễn Hữu Phong
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Nguyễn Hữu Phong'), 2);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Nguyễn Hữu Phong'), 16);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Nguyễn Hữu Phong'), 25);

-- Order items cho đơn hàng của: Trần Thị Yến
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Trần Thị Yến'), 7);

-- Order items cho đơn hàng của: Lê Văn Sơn
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Lê Văn Sơn'), 20);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Lê Văn Sơn'), 33);

-- Order items cho đơn hàng của: Phạm Ngọc Quỳnh
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Phạm Ngọc Quỳnh'), 11);

-- Order items cho đơn hàng của: Hoàng Thị Giang
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Hoàng Thị Giang'), 28);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Hoàng Thị Giang'), 4);

-- Order items cho đơn hàng của: Đặng Anh Tuấn
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Đặng Anh Tuấn'), 24);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Đặng Anh Tuấn'), 36);

-- Order items cho đơn hàng của: Bùi Thùy Trang
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Bùi Thùy Trang'), 6);

-- Order items cho đơn hàng của: Đỗ Văn Việt
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Đỗ Văn Việt'), 29);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Đỗ Văn Việt'), 10);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Đỗ Văn Việt'), 17);

-- Order items cho đơn hàng của: Nguyễn Thị Oanh
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Nguyễn Thị Oanh'), 32);

-- Order items cho đơn hàng của: Trần Hữu Nam
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Trần Hữu Nam'), 21);

-- Order items cho đơn hàng của: Lê Bảo An
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Lê Bảo An'), 3);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Lê Bảo An'), 26);

-- Order items cho đơn hàng của: Phạm Thanh Sơn
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Phạm Thanh Sơn'), 15);

-- Order items cho đơn hàng của: Vũ Văn Khoa
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Vũ Văn Khoa'), 23);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Vũ Văn Khoa'), 1);

-- Order items cho đơn hàng của: Võ Ngọc Lan
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Võ Ngọc Lan'), 19);

-- Order items cho đơn hàng của: Đặng Minh Dũng
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Đặng Minh Dũng'), 8);

-- Order items cho đơn hàng của: Bùi Thị Mai
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Bùi Thị Mai'), 20);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Bùi Thị Mai'), 13);

-- Order items cho đơn hàng của: Đỗ Văn Hải
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Đỗ Văn Hải'), 5);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Đỗ Văn Hải'), 22);

-- Order items cho đơn hàng của: Nguyễn Thị Quỳnh
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Nguyễn Thị Quỳnh'), 11);

-- Order items cho đơn hàng của: Trần Anh Việt
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Trần Anh Việt'), 31);

-- Order items cho đơn hàng của: Phạm Hữu Cường
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Phạm Hữu Cường'), 28);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Phạm Hữu Cường'), 7);

-- Order items cho đơn hàng của: Hoàng Văn Nam
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Hoàng Văn Nam'), 14);

-- Order items cho đơn hàng của: Vũ Thị Yến
INSERT INTO order_item (quantity, order_id, product_id) VALUES (3, (SELECT id FROM orders WHERE full_name = 'Vũ Thị Yến'), 33);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (5, (SELECT id FROM orders WHERE full_name = 'Vũ Thị Yến'), 16);
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Vũ Thị Yến'), 25);

-- Order items cho đơn hàng của: Võ Minh Trang
INSERT INTO order_item (quantity, order_id, product_id) VALUES (6, (SELECT id FROM orders WHERE full_name = 'Võ Minh Trang'), 6);

-- Order items cho đơn hàng của: Đặng Văn Bình
INSERT INTO order_item (quantity, order_id, product_id) VALUES (4, (SELECT id FROM orders WHERE full_name = 'Đặng Văn Bình'), 17);
